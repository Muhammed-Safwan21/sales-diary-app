      ...
      >
        ...
        >
          ...
          <Animated.View entering={FadeInUp.delay(100)}>
            <BlurView intensity={themeType === 'dark' ? 15 : 80} tint={themeType} style={styles.section}>
              ...
              {renderFormInput(
                ...
                (text) => setInvoiceDetails({...invoiceDetails, customerName: text}),
              ...
              {renderFormInput(
                'Due Date',
                invoiceDetails.dueDate,
                (text) => setInvoiceDetails({...invoiceDetails, dueDate: text}),
                undefined,
                <Calendar size={18} color={theme.colors.textSecondary} />,
                false
              )}
                        ...
                        <View style={styles.priceContainer}>
                          ...
                          <View style={styles.priceInputContainer}>
                            <View style={[
                              ...
                              <IndianRupee size={12} color={theme.colors.primary} />
                            </View>
                            <TextInput
                              style={[
                                styles.smallInput,
          ...
          <Animated.View entering={FadeInUp.delay(300)}>
            <BlurView intensity={themeType === 'dark' ? 15 : 80} tint={themeType} style={styles.totalSection}>
              <LinearGradient
                colors={[
