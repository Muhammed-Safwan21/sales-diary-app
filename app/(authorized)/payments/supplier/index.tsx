...
export default function SupplierPaymentsListingScreen() {
  const { theme, themeType }: any = useTheme();
  const router = useRouter();
  const [payments, setPayments] = useState(mockSupplierPayments);
  ...
  const handleViewPayment = (paymentId: string) => {
    router.push(`/payments/supplier/${paymentId}`);
  };
  ...
  const filteredPayments = payments.filter((pay) => {
    ...
    return pay.status === selectedFilter;
  });
      ...
      <SafeAreaView>
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>Supplier Payments</Text>
          </View>
          ...
          <View style={styles.summaryRow}>
            ...
            >
              ...
              <Text style={styles.summaryValue}>
                ₹{payments.reduce((sum, pay) => sum + pay.amount, 0).toLocaleString('en-IN')}
              </Text>
            </BlurView>
          </View>
        </View>
  ...
  const renderPaymentCard = (pay: any, index: number) => (
    <Animated.View
      key={pay.id}
      ...
      >
        ...
        >
          <View style={styles.cardContent}>
            ...
            {/* Purchase Order and Payment Method Row */}
            <View style={styles.poRow}>
              <Text style={[styles.poText, { color: theme.colors.textSecondary }]}> 
                {pay.purchaseOrder} • {pay.paymentMethod}
              </Text>
            </View>
  ...
  const renderFloatingActionButton = () => (
    ...
    >
      <TouchableOpacity
        ...
        onPress={() => router.push('/payments/supplier/form')}
        activeOpacity={0.8}
      >
