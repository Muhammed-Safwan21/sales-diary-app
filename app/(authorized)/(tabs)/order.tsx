    ...
    return (
      ...
      >
        ...
        <View style={styles.productImageContainer}>
          <Image source={{ uri: item.image }} style={styles.productImage} />
          <LinearGradient
            colors={["rgba(0,0,0,0.01)", "rgba(0,0,0,0.15)"]}
            start={{ x: 0, y: 0 }}
            end={{ x: 0, y: 1 }}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View>
            <Text style={styles.headerTitle}>Products</Text>
            <Text style={styles.headerSubtitle}>Find your perfect device</Text>
          </View>
          <TouchableOpacity
          ...
          >
            <LinearGradient
              ...
              style={styles.addButtonIndicator}
            >
        ...
        <View style={styles.searchContainer}>
          <View style={styles.searchBar}>
            <Image
              source={{
                uri: "https://img.icons8.com/ios-filled/50/4D5DFA/search.png",
              }}
              style={styles.searchIcon}
            />
            <TextInput
      ...
      {filteredProducts.length > 0 ? (
        ...
        <View style={styles.noResultsContainer}>
          <Image
            source={{
              uri: "https://img.icons8.com/ios-filled/100/4D5DFA/search-no-results.png",
            }}
            style={styles.noResultsIcon}
          />
          <Text style={styles.noResultsText}>No products found</Text>
...
const styles = StyleSheet.create({
  ...
  searchBar: {
    ...
    height: 40,
    borderWidth: 1,
    borderColor: "rgba(77, 93, 250, 0.1)",
  },
  searchIcon: {
    width: 18,
    height: 18,
  ...
  productCard: {
    ...
    overflow: "hidden",
    borderWidth: 1,
    borderColor: "rgba(33, 35, 54, 0.08)",
