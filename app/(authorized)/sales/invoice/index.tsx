...
export default function SalesInvoiceListingScreen() {
  ...
  const renderInvoiceCard = (inv: any, index: number) => (
    <Animated.View
      key={inv.id}
    ...
    <Animated.View entering={FadeIn.delay(300)} style={styles.emptyContainer}>
      ...
      >
        ...
        <Text style={[styles.emptyTitle, { color: theme.colors.text }]}> 
          No {selectedFilter === 'all' ? '' : selectedFilter} invoices
        </Text>
        <Text
  ...
  const renderFloatingActionButton = () => (
    ...
    >
      <TouchableOpacity
        ...
        onPress={() => router.push('/sales/invoice/form')}
        activeOpacity={0.8}
      >
