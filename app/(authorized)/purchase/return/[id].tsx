...
export default function PurchaseReturnView() {
  ...
  const ret = mockReturns.find((r) => r.id === id) || mockReturns[0];
  ...
  const handleEdit = () => {
    router.push(`/purchase/return/form/create?id=${ret.id}`);
  };
  const handleDelete = () => {
    Alert.alert(
      'Delete Return',
        ...
        <SafeAreaView>
          <View style={styles.header}>
            ...
            <View style={styles.headerTitleContainer}>
              ...
              <Text style={[styles.headerTitle, { color: theme.colors.text }]}>Purchase Return</Text>
            </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}  showsVerticalScrollIndicator={false}>
        <BlurView intensity={themeType === 'dark' ? 15 : 80} tint={themeType} style={styles.section}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={[styles.detailValue, { color: theme.colors.text }]}>{ret.supplierName}</Text>
          </View>
          <View style={styles.detailRow}>
